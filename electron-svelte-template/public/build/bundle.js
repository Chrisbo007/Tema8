    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1v5ahrt");
    			add_location(h1, file, 38, 4, 935);
    			add_location(hr, file, 39, 4, 967);
    			add_location(p, file, 42, 0, 1018);
    			add_location(button0, file, 44, 1, 1034);
    			add_location(button1, file, 46, 1, 1105);
    			attr_dev(div, "class", "stuff svelte-1v5ahrt");
    			add_location(div, file, 40, 0, 972);
    			attr_dev(main, "class", "svelte-1v5ahrt");
    			add_location(main, file, 37, 0, 924);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			dispose = [
    				...
    				listen_dev(div, "contextmenu", /*context*/ ctx[3], false, false, false)
    			];
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*info*/ 1) set_data_dev(t3, /*info*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
